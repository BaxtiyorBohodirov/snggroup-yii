...
class NewsSearch extends News
{
    ...
    {
        return [
            [['id', 'created_at', 'updated_at', 'status', 'order', 'views'], 'integer'],
            [['image', 'big_image', 'title_uz', 'title_ru', 'title_en', 'sub_content_uz', 'sub_content_ru', 'sub_content_en', 'content_uz', 'content_ru', 'content_en', 'date', 'slug'], 'safe'],
        ];
    }
