...
/* @var $searchModel app\models\search\AboutItemsSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = Yii::t('app', 'About Items');
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="about-items-index">

    <h1><?= Html::encode($this->title) ?></h1>
    <?php // echo $this->render('_search', ['model' => $searchModel]); ?>

    <!-- <p> -->
        <?= Html::a(Yii::t('app', 'Create About Items'), ['create'], ['class' => 'btn btn-success']) ?>
    <!-- </p> -->
