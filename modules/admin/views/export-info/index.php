...
/* @var $searchModel app\models\search\ExportInfoSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = Yii::t('app', 'Export Infos');
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="export-info-index">

    <h1><?= Html::encode($this->title) ?></h1>
    <?php // echo $this->render('_search', ['model' => $searchModel]); ?>

    <!-- <p> -->
        <?= Html::a(Yii::t('app', 'Create Export Info'), ['create'], ['class' => 'btn btn-success']) ?>
    <!-- </p> -->
