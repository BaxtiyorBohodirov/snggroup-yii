...
<div class="product-menu-form">
    ...
    <?= $form->field($model, 'menu_uz')->textInput(['maxlength' => true]) ?>

    <?= $form->field($model, 'menu_en')->textInput(['maxlength' => true]) ?>

    <?= $form->field($model, 'menu_ru')->textInput(['maxlength' => true]) ?>
    ...
    <?= $form->field($model, 'product_id')->dropDownList(ArrayHelper::map(Products::find()->published()->all(), 'id','title_ru'),
    [
