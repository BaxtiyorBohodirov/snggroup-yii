...
<div class="products-form">
    ...
    <?= $form->field($model, 'base_files')->widget(trntv\filekit\widget\Upload::className(), 
    [
    ...
    <?= $form->field($model, 'parent_id')->dropDownList(ArrayHelper::map(Categories::find()->all(),'id','title_ru'),
    [
