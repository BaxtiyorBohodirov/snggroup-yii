...
$phones=Phones::find()->andWhere(['status'=>BaseModel::STATUS_ACTIVE])->orderBy('order')->limit(3)->all();
$contact=Contacts::find()->andWhere(['status'=>BaseModel::STATUS_ACTIVE])->orderBy('order')->one();
$carousel=Carousel::find()->published()->orderBy('order')->all();
$socials=Socials::find()->published()->orderBy('order')->one();
                ...
                <div class="header-item">
                       ...
                       <?php for($i=0;$i<2;$i++):?>
                        ...
                        <div class="header-lang">
                            <div class="header-lang-top d-f">
                                <p class="h6 f-med text-upper mr-l"><?=Yii::$app->language?></p>
                                <img class="ob-cont" src="/app/images/green-arrow.png" alt="">
                            </div>
                            <ul class="header-lang-bottom" style="height: auto;">
                                <li><a href="/site/set-language?l=ru" class="h6 f-med text-upper main-col">RU</a></li>
                                <li><a href="/site/set-language?l=uz" class="h6 f-med text-upper main-col">UZ</a></li>
                                <li><a href="/site/set-language?l=en" class="h6 f-med text-upper main-col">EN</a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="header-item-bottom w-100">
                        ...
                        <ul class="header-menu w-100 d-f justify-content-between">
                            <li><a href="" class="f-14 f-med text-upper link-col"><?=Yii::t('app', 'Главная');?></a></li>
                            <li><a href="" class="f-14 f-med text-upper link-col active"><?=Yii::t('app', 'О компании');?></a></li>
                            <li><a href="" class="f-14 f-med text-upper link-col"><?=Yii::t('app', 'Продукция');?></a></li>
                            <li><a href="" class="f-14 f-med text-upper link-col"><?=Yii::t('app', 'Новости');?></a></li>
                            <li><a href="" class="f-14 f-med text-upper link-col"><?=Yii::t('app', 'Контакты');?></a></li>
            ...
            <div class="container">
                <div class="row equal-offsets  pt-3 pb-3">
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-6 pl-4">
                        <?php for($i=0;$i<3;$i++):?>
                            <div class="footer-center-block d-f <?php if($i!=0)echo "mt-l"?>">
                                    <p class="mr-l"><svg xmlns="http://www.w3.org/2000/svg"
                                ...
                                <a href=<?=$phones[$i]->phone?> class="h5 f-bold wh-col"><?=$phones[$i]->phone?></a>
                                <p class="ml-1"><img src="/app/images/telegram.png" alt=""></p>
                                <p class="footer-icon ml-l"><svg xmlns="http://www.w3.org/2000/svg"
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6">
                        <div class="footer-menu-wrap d-f">
                            <ul class="footer-menu-1">
                                <li><a href="" class="f-14 f-med wh-col text-upper"><?=Yii::t('app', 'Главная');?></a></li>
                                <li><a href="" class="f-14 f-med wh-col text-upper"><?=Yii::t('app', 'О компании');?></a></li>
                                <li><a href="" class="f-14 f-med wh-col text-upper"><?=Yii::t('app', 'Продукция');?></a></li>
                            </ul>
                            <div class="footer-menu-2">
                                <li><a href="" class="f-14 f-med wh-col text-upper"><?=Yii::t('app', 'Новости');?></a></li>
                                <li><a href="" class="f-14 f-med wh-col text-upper"><?=Yii::t('app', 'Контакты');?></a></li>
                            </div>
                        </div>
                    </div>
                </div>
